...
for (i = 0; i < got.houses[1].people.length; i++) {
  console.log(`I am ${got.houses[1].people[i].name} and I am ${got.houses[1].people[i].description}.`);
}
...
for (i = 0; i < got.houses[0].people.length; i++) {
  console.log(`I am ${got.houses[0].people[i].name} and I am the ${got.houses[0].people[i].description}.`);
}
...
for (i = 0; i < got.houses.length; i++) {
  houseLength[got.houses[i].name] =  got.houses[i].people.length;
}
